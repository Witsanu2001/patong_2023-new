    ...
    <?php include "header.php"; ?>
      ...
      <main  class="container">
        ...
        <?php include "link-boot.php"; ?>
            <form action="buy_create.php" id="form_create" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
            <div class="row">
                    <div class="col-md-7">
                        <!-- ข้อมูลเนื้อหา -->
                        <div class="row mt-6">
                            ...
                            <div class="col-md-6 mt-3"  style="width: 800px;">
                                <label for="buy_name" class="form-label">ชื่อการประกาศ <span class="text-danger">*</span></label>
                                <input type="text" id="buy_name" name="buy_name" class="form-control" required>
                            </div>
                            ...
                            <div class="col-md-7 mt-2"  style="width: 800px;" >
                                ...
                                <textarea name="buy_title" id="buy_title" class="form-control" rows="4" required></textarea>
                            </div>
                            <!-- ปุ่มบันทึก -->
                    ...
                    <duv class="col-md-3">
                        ...
                        <div class="row mt-6" style="width: 800px;">
                            <div class="col-md-11 mt-3">
                                <label for="buy_date" class="form-label">วันที่ทำกิจกรรม <span class="text-danger">*</span></label>
                                <input type="date" id="buy_date" name="buy_date" class="form-control" required style="width: 200px;">
                            </div>
                            <div class="col-md-11 mt-3">
                                <label for="buy_pdf" class="form-label">รายละเอียด PDF</label>
                                <input class="form-control" id="buy_pdf" name="buy_pdf" type="file" style="width: 500px;">
                            </div>
                        </div>
                    </duv>
                </div>
