    ...
    <?php include "header.php"; ?>
      ...
      <main  class="container">
        ...
        <?php include "link-boot.php"; ?>
            <form action="support_update.php" id="form_create" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
            <input type="hidden" name="sp_id" value="<?php echo $objResult['sp_id']; ?>">
                <div class="row">
                    <div class="col-md-7">
                        <!-- ข้อมูลเนื้อหา -->
                        <div class="row mt-6">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" id="sp_name" name="sp_name" value="<?php echo $objResult['sp_name']; ?>" class="form-control" required>
                            </div>
                            
                            <div class="col-md-6 mt-3">
                                <label for="sp_date" class="form-label">วันที่ <span class="text-danger">*</span></label>
                                <input type="date" id="sp_date" name="sp_date" value="<?php echo $objResult['sp_date']; ?>" class="form-control" required>
                            </div>
                            <!-- แถวที่ 2 -->
                            <div class="col-md-7 mt-2"  style="width: 800px;" >
                                ...
                                <textarea name="sp_title" id="sp_title" class="form-control" rows="4" required><?php echo $objResult['sp_title']; ?></textarea>
                            </div>
                            <!-- ปุ่มบันทึก -->
                            <div class="col-md-12 mt-3">
                                ...
                                <a href="#" class="btn btn-danger btn-lg" onclick="deleteItem(<?php echo $objResult['sp_id']; ?>);">ลบ</a>
                                    ...
                                    function deleteItem(indexId) {
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                // ถ้าผู้ใช้คลิก "ใช่"
                                                window.location.href = 'support_delete.php?id=' + indexId;
                                            }
                                        });
                                    }
                    ...
                    <duv class="col-md-3">
                        <!-- ข้อมูลรูปภาพ -->
                        <div class="row mt-6" style="width: 600px;">
                            ...
                            <div class="col-md-11 mt-3">
                            <?php if ($objResult['sp_img'] != '') { ?>
                                <img src="../images/support/<?php echo $objResult['sp_img']; ?>" class="img-thumbnail" id="img_preview" />
                            <?php } else { ?>
