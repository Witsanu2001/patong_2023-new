...
?>
  ...
  <div class="dropdown" >
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2" onclick="event.stopPropagation()">
      <li>
        <button class="dropdown-item" href="index.php" type="button" onclick="toggleSubMenu(event)"><a href="index.php">หน้าหลัก</a></button>
      ...
      <li>
        ...
        <ul class="submenu" style="display: none;">
          ...
          <li><button class="dropdown-item" type="button">
            <a href="#" data-toggle="modal" data-target="#exampleModalCall">
              เบอร์โทร : 076-342 633-4
            </a></button></li>
          <li><button class="dropdown-item" type="button">
            <a href="#" data-toggle="modal" data-target="#exampleModalfax">
              Fax : 076-340 617
            </a></button></li>
