      ...
      <section id="portfolio" class="portfolio" data-aos="fade-up">
        <div class="container">
          ...
          <div class="section-header">
            <h2><?php echo $objResult ['cn_name']?>&nbsp;<a href="clinic_edit.php?id=<?php echo $objResult ['cn_id']?>"><i class="bi bi-pencil-square"></i></a></h2>
            <a href="clinic.php" class="btn btn-outline-warning">กลับ</a>
            <br>
            <br>
                ...
                <div class="row g-0 portfolio-container">
                    <?php for ($i = 1; $i <= 3; $i++) : ?>
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item" style="width: 423px;">
                            ...
                            <a href="../images/clinic/<?php echo $objResult_s['img_'. $i] ?>" class="glightbox details-link"><i class="bi bi-zoom-in"></i></a>
                            </div>
                        </div>
                    <?php endfor; ?>
                </div>
