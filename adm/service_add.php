    ...
    <?php include "header.php"; ?>
      ...
      <main  class="container">
        ...
        <?php include "link-boot.php"; ?>
            <form action="service_create.php" id="form_create" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                <div class="row">
                    <div class="col-md-7">
                        <!-- ข้อมูลเนื้อหา -->
                        <div class="row mt-6">
                            ...
                            <div class="col-md-6 mt-3">
                                <label for="sv_name" class="form-label">ชื่องานบริการ <span class="text-danger">*</span></label>
                                <input type="text" id="sv_name" name="sv_name" class="form-control" required>
                            </div>
                            
                            <!-- แถวที่ 2 -->
                            <div class="col-md-7 mt-2"  style="width: 800px;" >
                                <label for="sv_title" class="form-label">รายละเอียดงานบริการ <span class="text-danger">*</span></label>
                                <textarea name="sv_title" id="sv_title" class="form-control" rows="4" required></textarea>
                            </div>

                            <div class="col-md-7 mt-2"  style="width: 800px;" >
                                <label for="sv_details" class="form-label">รายละเอียดศูนย์บริการ <span class="text-danger">*</span></label>
                                <textarea name="sv_details" id="sv_details" class="form-control" rows="4" required></textarea>
                            </div>
                            <!-- ปุ่มบันทึก -->
                    ...
                    <duv class="col-md-3">
                        ...
                        <div class="row mt-6" style="width: 800px;">
                            <div class="col-md-11 mt-3">
                                <label for="sv_img" class="form-label">รูปภาพ LOGO งานบริการ</label>
                        ...
                        <div class="row mt-6" style="width: 800px;">
                            <div class="col-md-11 mt-3">
                                <label for="img_1" class="form-label">รูปภาพงานบริการ 1</label>
                        ...
                        <div class="row mt-6" style="width: 800px;">
                            <div class="col-md-11 mt-3">
                                <label for="img_2" class="form-label">รูปภาพงานบริการ 2</label>
                        ...
                        <div class="row mt-6" style="width: 800px;">
                            <div class="col-md-11 mt-3">
                                <label for="img_3" class="form-label">รูปภาพงานบริการ 3</label>
