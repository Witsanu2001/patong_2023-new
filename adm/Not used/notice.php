...
if(isset($_GET['start'])){
	...
	$Qnews = mysql_query("SELECT * FROM tb_news WHERE news_type='1' OR news_type='2' ORDER BY news_id DESC LIMIT $start,$limit");
...
<div class="content">
    ...
    <div class="row-main">
        ...
        <div class="col-cr">
        	<div class="toppic">ข่าวสาร / ประชาสัมพันธ์</div>
...
echo"</span><br />
		...
		<div class='readmore-news'><span class='glyphicon glyphicon-calendar'></span> $news_date
