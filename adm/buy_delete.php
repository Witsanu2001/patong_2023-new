...
$sql_delete = "DELETE FROM buy WHERE buy_id=$id";
$result_delete = mysqli_query($conn, $sql_delete);

// 2. หาค่า buy_date ล่าสุดจากตาราง buy
$sql_max_date = "SELECT MAX(buy_date) AS max_date FROM buy";
...
// 3. อัปเดตค่า buy_date ล่าสุดในตาราง index_page สำหรับแถวที่ b_id เท่ากับ 2
$sql_update_index_page = "UPDATE index_pag SET b_time='$max_date' WHERE b_id=2";
