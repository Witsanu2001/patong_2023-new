    ...
    <?php include "header.php"; ?>
      ...
      <main  class="container">
        ...
        <?php include "link-boot.php"; ?>
            <form action="clinic_create.php" id="form_create" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                <div class="row">
                    <div class="col-md-7">
                        <!-- ข้อมูลเนื้อหา -->
                        <div class="row mt-6">
                            ...
                            <div class="col-md-6 mt-3">
                                <label for="cn_name" class="form-label">ชื่อคลินิก <span class="text-danger">*</span></label>
                                <input type="text" id="cn_name" name="cn_name" class="form-control" required>
                            </div>
                            
                            <!-- แถวที่ 2 -->
                            <div class="col-md-7 mt-2"  style="width: 800px;" >
                                <label for="cn_title" class="form-label">รายละเอียดคลินิก <span class="text-danger">*</span></label>
                                <textarea name="cn_title" id="cn_title" class="form-control" rows="4" required></textarea>
                            </div>
                            <!-- ปุ่มบันทึก -->
                            <div class="col-md-12 mt-3">
                            <button type="button" id="saveButton" class="btn btn-primary btn-lg" onclick="saveItem()">บันทึก</button>
                            <a href="clinic.php" class="btn btn-warning btn-lg">ยกเลิก</a>
                    ...
                    <duv class="col-md-3">
                        ...
                        <div class="row mt-6" style="width: 800px;">
                            <div class="col-md-11 mt-3">
                                <label for="cn_img" class="form-label">รูปภาพคลินิก</label>
