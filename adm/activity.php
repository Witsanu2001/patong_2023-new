...
<main class="curtain-container container">
    ...
    <section id="portfolio" class="portfolio" data-aos="fade-up">
        ...
        <div class="container">
        <a href="act.php" class="btn btn-outline-warning">กลับ</a>
        <?php $objResult_n = mysqli_fetch_array($objQuery_n, MYSQLI_ASSOC) ?>
        <div class="section-header">
            <h2><?php echo $objResult_n['atv_name']?><a href="atv_edit.php?id=<?php echo $objResult_n['atv_id']?>">&nbsp;<i class="bi bi-pencil-square"></i></a></h2>
                    ...
                    for ($i = 1; $i <= 8; $i++) {
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item">
                            ...
                            <div class="portfolio-info">
                                ...
                                <a href="atv_img_delete.php?id=<?php echo $objResult['atv_img'.$i];?>" class="details-link">&nbsp;<i class="bi bi-pencil-square"></i></a>
                            </div>
                        </div>
                        <?php
                    }
        ...
        <div class="container" data-aos="fade-up">
            ...
            <?php while ($objResult_s = mysqli_fetch_array($objQuery_s, MYSQLI_ASSOC)) { ?>
                <div class="swiper-slide"><a href="activity.php?id=<?php echo $objResult_s["atv_id"];?>"><img src="../images/activity/<?php echo $objResult_s["atv_img1"];?>" class="img-fluid" alt=""></a></div>
            <?php } ?>
            </div>
